  ...
  <body>
    <%
      ...
      if (numeroDeExpo.getRow() != 0) {
        ...
        String insercion = "INSERT INTO exposicion VALUES (" + Integer.valueOf(request.getParameter("CodExpo"))
    ...
    %>
    <br>
    <a href="index.jsp" class="icon"><span class="icon"></span> Página principal</button>
